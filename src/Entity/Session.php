...
class Session
{
    ...
    {
        $dateDebutFR = $this->dateDebut->format('d.m.Y');
        return $dateDebutFR;
    }
    ...
    {
        $dateFinFR = $this->dateFin->format('d.m.Y');
        return $dateFinFR;
    }
    ...
    {
        $dureeSession = strtotime($this->getDateFinFR()) - strtotime($this->getDateDebutFR());
        return round($dureeSession / (60 * 60 * 24));
    }
